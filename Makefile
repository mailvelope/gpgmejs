...
# lang/js/Makefile.  Generated from Makefile.in by configure.
...
am__relativize = \
  ...
  reldir="$$dir2"
ACLOCAL = ${SHELL} /Users/toberndo/dev/gpgme/gpgme/build-aux/missing aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AS = as
AUTOCONF = ${SHELL} /Users/toberndo/dev/gpgme/gpgme/build-aux/missing autoconf
...
CXXFLAGS = -g -O2 -Wall -Wextra -Wno-shadow
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
DLLTOOL = false
...
GPG_ERROR_MT_CFLAGS = -I/Users/toberndo/dev/gpgme/bin/include
GPG_ERROR_MT_LIBS = -L/Users/toberndo/dev/gpgme/bin/lib -lgpg-error -lpthread
GRAPHVIZ = 
GREP = /usr/bin/grep
HAVE_CXX11 = 1
HAVE_DOT = NO
...
LTLIBOBJS = 
MAINT = 
MAKEINFO = ${SHELL} /Users/toberndo/dev/gpgme/gpgme/build-aux/missing makeinfo
MANIFEST_TOOL = :
...
abs_top_srcdir = /Users/toberndo/dev/gpgme/gpgme
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /Users/toberndo/dev/gpgme/gpgme/build-aux/install-sh
